...
<div class="container container2">
  <div class="contain">
    ...
    <div class="leftcontent"> 
      <div class="title"><em class="icon ii"></em><h1>面试</h1></div>
...
$("#listTopic").data("url","topic/listWebTopic?typeid=5").load("topic/listWebTopic?typeid=5");
...
function searchTopic(){
  ...
  var url = "topic/listWebTopic?typeid=5";
  if (pinyin) {
    url += "&pinyin=" + pinyin;
  }
