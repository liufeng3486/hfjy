...
<div class="container container2">
  <div class="contain">
    ...
    <div class="leftcontent"> 
      <div class="title"><em class="icon ip"></em><h1>政策</h1></div>
...
$("#listTopic").data("url","topic/listWebTopic?typeid=6").load("topic/listWebTopic?typeid=6");
...
function searchTopic(){
  ...
  var url = "topic/listWebTopic?typeid=6";
  if (pinyin) {
    url += "&pinyin=" + pinyin;
  }
